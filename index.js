...
export const typographyCSS = `
  ...
  @media(max-width:1440px){:root{--fs-display:48px;--fs-headingl:40px;--fs-headingm:26px;--fs-headings:20px;--fs-headingxs:16px;--fs-bodyl:18px;--fs-body:15px;--fs-bodys:13px;--fs-bodyxs:12px;--fs-caps:10px;--fs-button:11px;--fs-navbar:13px;--fs-navlabel:11px;--fs-quote:18px}}
  @media(max-width:768px){:root{--fs-display:40px;--fs-headingl:34px;--fs-headingm:22px;--fs-headings:18px;--fs-headingxs:15px;--fs-bodyl:17px;--fs-body:15px;--fs-bodys:13px;--fs-bodyxs:12px;--fs-caps:10px;--fs-button:11px;--fs-navbar:14px;--fs-navlabel:11px;--fs-quote:16px}}
`
